...
if [ "${TYPE}" == Product ]; then
	...
	if [[ $FILTER_POLICY == "product" || $BACKEND_OAUTH_POLICY == "product" || $RATE_POLICY == "product" || $CACHE_POLICY == "product" || $CORRELATION_POLICY == "product" || $JWT_POLICY == "product" || $CORS_POLICY_APPLY == "product" ]]; then
		...
		if [[ $FILTER_POLICY == "api" || $BACKEND_OAUTH_POLICY == "api" || $RATE_POLICY == "api" || $CACHE_POLICY == "api" || $CORRELATION_POLICY == "api" || $JWT_POLICY == "api" || $CORS_POLICY_APPLY == "api" ]]; then
			...
			if [ "${PRODUCTNAME}" != null ] && [ "$FILTER_POLICY" != "product" ] && [ "$BACKEND_OAUTH_POLICY" != "product" ] && [ "$RATE_POLICY" != "product" ] && [ "$CACHE_POLICY" != "product" ] && [ "$CORRELATION_POLICY" != "product" ] && [ "$JWT_POLICY" != "product" ] && [ "$CORS_POLICY_APPLY" != "product" ]; then
